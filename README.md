...
>
>Dla wariantów wdrożeniowych typ A, C, D należy dowymiarować łącze `s1-h2`. Jako wartości startowe przepływność łącza i wielkości bufora można przyjąć: dla wariantów A i C: 10mbit/s i 50, dla wariantu D 100mbit/s i 100.
