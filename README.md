...
* (4) Następnie, dla każdego z wyznaczonych obciążeń odniesienia, przeprowadzamy właściwą _serię elementarną_:
  ...
  * po wykonaniu wszystkich pomiarów elementarnych w ramach serii elementarnej uśredniamy wartość każdej z wymienionych metryk (zauważmy, że w ten sposób korygujemy wartość _obciążenia zmierzonego_ z kroku (3) do wartości zgodnej z metryką [1] - średnią liczbą faktycznie wygenerowanych pakietów w poszczególnych pomiarach elementarnych danej serii elementarnej).
